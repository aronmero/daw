...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'admin.grupo.create'])->syncRoles([$admin, $profesor]);
        Permission::create(['name' => 'admin.grupo.edit'])->syncRoles([$admin, $profesor]);
        Permission::create(['name' => 'admin.grupo.destroy'])->syncRoles([$admin, $profesor]);
    }
}
